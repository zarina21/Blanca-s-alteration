      ...
      <section className="section">
        ...
        <div className="columns is-vcentered service-box">
          ...
          <div className="column is-half">
            ...
            <p>The shoulders, being the architectural cornerstone of a jacket, require an expert hand to fit. Trying to reshape them is akin to reshaping one's destiny, an intricate matter best approached with caution. The symphony of points and structure woven into a shoulder demands reverence. Be aware of the dangers of trying to resize, which is often not recommended. It is a path fraught with complexities, like navigating through the intricate tapestry of life. However, if the need arises to recalibrate the padding, there is a great possibility. Removing the padding gives your jacket a touch of Neapolitan nonchalance, while increasing the padding pays homage to a more rugged British silhouette.</p>
          </div>
        </div>
